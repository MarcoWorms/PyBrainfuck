...
estrutura = [0] * 30000  # vetor com 30.000 posições, isso deve ser o programa
ponteiro = 0             # ponteiro indicando qual é a célula atual do programa
...
if __name__ == "__main__":
    ...
    if(len(argv) > 1):
        if (argv[1].lower() == "exemplo" or argv[1].lower() == "exemplo.bf"):
            # hello world
            programa = "++++++++[>++++[>++>+++>+++>+<<<<-]>+>+>->>+[<]<-]>>   \
                       .>---.+++++++..+++.>>.<-.<.+++.------.--------.>>+.>++."
        else:
